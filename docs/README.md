...
**要改前端代码（包括让 AI 改）先看 [前端 AI 索引](./FRONTEND-INDEX.md)**：目录职责、四条主链路（创作/请求与身份/站点归属/画布）、必须遵守的约定，以及 `docs/frontend-index/` 下由源码自动生成的符号索引（组合式函数方法、组件 props/emits、页面路由、类型字段）。该索引由 `npm run index:frontend` 维护，改完代码要一起提交。
